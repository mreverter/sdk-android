 ...
 */
public class VaultActivityWithGuessingCardFormTest extends BaseTest<VaultActivity> {

    public VaultActivityWithGuessingCardFormTest() {
    ...
    public void testHappyPath(){
        ...
        Instrumentation.ActivityMonitor guessingCardFormMonitor = getInstrumentation().addMonitor(GuessingCardActivity.class.getName(), guessingCardFormMockedResult, true);
