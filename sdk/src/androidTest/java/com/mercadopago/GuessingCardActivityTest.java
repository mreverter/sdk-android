 ...
 */
public class GuessingCardActivityTest  extends BaseTest<GuessingCardActivity> {
    private GuessingCardActivity mActivity;
    ...
    private GuessingCardNumberController mGuessingCardNumberController;

    public GuessingCardActivityTest() {

        super(GuessingCardActivity.class);
    }
   ...
   public void testWhenBinEnteredAndThereIsOnlyOnePaymentMethodPossibleSetImageHidePMLayout()
   {
    ...
    private GuessingCardActivity prepareActivity(String keyType,
    ...
    private void setFields() {
        ...
        mPaymentMethodsLayout = (LinearLayout) mActivity.findViewById(R.id.layoutPaymentMethods);
